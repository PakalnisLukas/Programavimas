...
int main()
{
    ...
    if (EntryChoice == 1)
    {
        ...
        {
            NewLine();
            cout << "Iveskite " << S.size() + 1 << "studento varda bei pavarde, baige paspauskite Enter" << endl;
            getline(cin, Entry);
            ...
            else
            {
                ...
                else
                {
                    ...
                    for (list<Studentas>::iterator IT = Failed.begin(); IT != Failed.end(); IT++)
                    {
                        ...
                        if (AverageChoice == 1)    IrasymasNeigiami << std::fixed << setprecision(2) << GP((*IT), Vidurkis) << setprecision(prec) << endl;
                        else  IrasymasNeigiami << std::fixed << setprecision(2) << GP((*IT), Mediana) << setprecision(prec) << endl;
                    ...
                    for (list<Studentas>::iterator IT = S.begin(); IT != S.end(); IT++)
                    {
                        ...
                        streamsize prec = cout.precision();
                        if (AverageChoice == 1)    IrasymasTeigiami << std::fixed << setprecision(2) << GP((*IT), Vidurkis) << setprecision(prec) << endl;
                        else  IrasymasTeigiami << std::fixed << setprecision(2) << GP((*IT), Mediana) << setprecision(prec) << endl;
                    }
                    for (auto i = 0; i != IlgiausiasVardas + IlgiausiaPavarde + 10; i++)
